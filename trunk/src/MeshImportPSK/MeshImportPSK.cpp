...
extern "C"
{
MESHIMPORTOGRE_API NVSHARE::MeshImporter * getInterface(PxI32 version_number);
};
...
extern "C"
{
  ...
  MeshImporter * getInterfaceMeshImportPSK(PxI32 version_number)
#else
MESHIMPORTOGRE_API MeshImporter * getInterface(PxI32 version_number)
#endif
{
  assert( gInterface == 0 );
